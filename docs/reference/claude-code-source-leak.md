...
# Claude Code Source Analysis Reference / Claude Code 源码分析参考
...
## 文章最核心的几个观点 / Core Points From The Article

### 1. Agent Loop 本身很简单 / The Agent Loop Itself Is Simple
...
### 2. 工业级系统的复杂度都在 Harness 外围 / Industrial Complexity Lives Around The Harness
...
### 3. 上下文压缩是核心能力 / Context Compression Is A Core Capability
...
### 4. 多 Agent 的关键是隔离 / The Key To Multi-Agent Is Isolation
...
### 5. 权限系统是零信任安全架构 / The Permission System Is A Zero-Trust Safety Architecture

文章里权限系统非常重，说明一个成熟 Agent 产品必须默认不信任自己。

这和普通 demo 的差别非常大。

### 6. 记忆和成本控制都必须架构化 / Memory And Cost Control Must Be Architectural
...
## 本项目已经有的骨架 / What This Project Already Has
...
## 我们当前最明显的短板 / Our Most Visible Gaps

如果直接对照这篇文章，当前项目还明显缺少这些能力：

### 1. 上下文压缩体系 / Context Compression System
...
### 3. 流式执行与投机执行 / Streaming And Speculative Execution
...
### 4. 多 Agent 隔离模式 / Multi-Agent Isolation Model
...
### 5. 更厚的权限与安全体系 / Thicker Permission And Safety System
...
### 6. Prompt Cache / 成本控制体系 / Prompt Cache And Cost Control
...
### 7. Application Legibility / 应用可理解性
...
### 8. 更成熟的工具注册与 Schema 体系 / More Mature Tool Registry And Schema System
...
### 1. Loop 保持简单，复杂度放到 Harness 外围 / Keep The Loop Simple And Move Complexity Outside

不要把所有逻辑塞进 agent loop 本身。

### 2. 权限系统必须继续加厚 / The Permission System Must Keep Thickening

安全控制不是“后面再补”，而是产品成立的前提。

### 3. 上下文压缩要尽早设计 / Context Compression Should Be Designed Early

如果后面要承接更复杂任务，这一层迟早是必须项。

### 4. 多 Agent 重点是隔离，不是热闹 / Multi-Agent Work Is About Isolation, Not Spectacle

未来如果演进多 Agent，优先考虑隔离模型，而不是堆数量。

### 5. 成本、缓存、记忆都要提前进入架构视野 / Cost, Cache, And Memory Must Enter The Architecture Early
