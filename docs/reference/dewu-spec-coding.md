...
# Dewu Spec Coding Reference / 得物 Spec Coding 参考
...
### 1. Spec Coding 的价值不是“写文档”，而是先消除不确定性 / The Value Of Spec Coding Is Reducing Uncertainty Before Execution
...
### 2. 规范不能只有约束，还要有示范和视觉锚点 / Standards Need Examples And Visual Anchors, Not Just Constraints
...
### 3. MCP 的价值是消除信息孤岛 / MCP Removes Information Silos
...
### 4. AI 更像“顶级执行者”，不是自带业务常识的专家 / AI Is More Like A Top-Tier Executor Than A Domain Expert
...
### 5. AI 的失效是结构性的 / AI Failure Is Structural
...
## 本项目已经做到的部分 / What This Project Already Has
...
## 本项目还缺的部分 / What This Project Still Lacks
...
### 2. 外部信息接入层 / External Information Access Layer

文章里有 MCP 直连接口文档和飞书文档；
我们现在的信息层主要还是 repo 内知识，外部上下文接入还很弱。

### 3. 按复杂度分层的工作流 / Workflows Layered By Complexity
...
### 1. 从“规则”升级到“规则 + 模板 + 视觉锚点” / Move From Rules To Rules, Templates, And Visual Anchors

仅有约束还不够，后续需要让 AI 看到标准产出样子。

### 2. 把失效模式写进 Harness 设计 / Write Failure Modes Into The Harness Design
...
### 3. 让开发者角色上移 / Move The Developer Role Upward

这篇文章和 Harness Engineering 一样，都在强调：

开发者不会消失，但重心会从“写代码”转向“定义边界、搭建环境、维护确定性空间”。

### 4. 工作流要按任务颗粒度分层 / Layer Workflows By Task Granularity
